...
This implementation provides the Arquillian integration with a remote GlassFish 
container. You can use your normal GlassFish deployment to perform your test. The 
integration connects Arquillian to the DAS via the REST Interfaces to Administer 
GlassFish over the http or https protocol. This gives you the flexibility to use 
...
adminPort: The port to be used to access  Admin API. If omitted the default 
value is 4848.
...
web application, GlassFish will use the name of your deployment without the extension 
